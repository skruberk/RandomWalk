...
radius = 20;    %cell radius variable
target=radius/100;   %membrane disc variable size
...
for i = 2 :tsteps
    ...
    %checks if at target
	if any(abs(x - x_inner(i)) <= step_size/4) && any(abs(y - y_inner(i)) <= step_size/4)
